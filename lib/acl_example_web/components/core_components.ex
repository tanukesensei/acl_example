defmodule AclExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AclExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AclExampleWeb.Gettext, "errors", msg, opts)
    end
  end
